...
scenario_predictor = ScenarioPredictor(analyzer, os.getenv('GEMINI_API_KEY'), os.getenv('GEMINI_API_MODEL'))
stock_qa = StockQA(analyzer, os.getenv('GEMINI_API_KEY'), os.getenv('GEMINI_API_MODEL'))
